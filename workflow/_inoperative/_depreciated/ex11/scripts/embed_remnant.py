...
def main(system_, parameters):
    ...
    # Embed vectors
    remnant_vectors = embed_system(remnant_G, remnant_H, parameters, embedding_method = "node2vec")  # embed R
    observed_vectors = embed_system(observed_G, observed_H, parameters, embedding_method = "node2vec")  # embed theta
