...
def embed_system(remnant_G, remnant_H, hyperparams, embedding_method = "node2vec", per_component=False):
    ...
    # Apply embedding to remnant gra_dimension={{dimension}}phs
...
if __name__ == "__main__":
    ...
    hyperparams = dict(snakemake.params["hyperparams"])
    hyperparams.update({"dimensions": int(snakemake.wildcards.dimension)})
    remnant_vectors = main(system_, hyperparams)
